...
import { ITimeMixer, defaultTimeMixer, addTick, removeTick } from "../../melon_runtime/Timer.js";
import { Link } from "../../melon_runtime/Link.js";
import { recyclable } from "../../melon_runtime/ClassUtils.js";
import { MiniDispatcher, EventT } from "../../melon_runtime/MiniDispatcher.js";
//===========================================================================================
// Tweener
//===========================================================================================
...
export class ScriptTween extends MiniDispatcher{
    target:any;
    tweens:STweenBase[];
    tm:ITimeMixer;
