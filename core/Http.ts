import { EventHandler, MiniDispatcher, EventX, EventT, IEventDispatcherX } from "../../melon_runtime/MiniDispatcher.js";
import { Link } from "../../melon_runtime/Link.js";
import { amf_readObject } from "../../melon_runtime/AMF3.js";
...
export class JSonLoader extends Loader {
    ...
    constructor(perfix: string, url: string, dataType: wx.HttpResponseType = wx.HttpResponseType.ARRAY_BUFFER, method: wx.HttpMethod = wx.HttpMethod.GET) {
        super(perfix, url, wx.HttpResponseType.TEXT, method);
    }
...
export async function loadResaAsync(prefix: string, url: string,
    type?: ResType | LoaderType, priority: LoadPriority = LoadPriority.low,
    disposeTime: number = 30000) {

    let func = (resolve: any, reject: any) => {
        loadRes(prefix, url, (event: EventX) => {
            resolve(event);
        ...
        }, this, type, priority, disposeTime)
    }
